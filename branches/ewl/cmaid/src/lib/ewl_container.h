...
struct Ewl_Container
{
        ...
        Cmaid_List *children; /**< List of children that are contained. */
        Cmaid_Iter *iter_list; /**< List of the iterator attached to the
                                        container */
        int visible_children; /**< the number of visible children */
        int external_children; /**< the count of non-internal children */
...
void             ewl_container_child_resize(Ewl_Widget *w, int size,
                                                Ewl_Orientation o);
void             ewl_container_child_iterator_attach(Ewl_Container *c,
                                                Cmaid_Iter *iter);
void             ewl_container_child_iterator_detach(Ewl_Container *c,
                                                Cmaid_Iter *iter);
