...
static const Cmaid_Value ewl_io_manager_ext_value = {
        (Cmaid_Value_Compare_Cb)strcasecmp,
        cmaid_value_string_hash, 0, {NULL, NULL, NULL},
        {NULL, NULL}
};

static Ecore_Hash *ewl_io_manager_plugins = NULL;
static Cmaid_Map *ewl_io_manager_ext_icon_map = NULL;
...
ewl_io_manager_init(void)
{
        ...
        if (!ewl_io_manager_ext_icon_map)
        {
                ...
                ewl_io_manager_ext_icon_map = cmaid_hash_map_new(
                                                &ewl_io_manager_ext_value,
                                                &cmaid_value_pointer);
                /* Images */
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".png",
                                                EWL_ICON_IMAGE_X_GENERIC);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".jpg",
                                                EWL_ICON_IMAGE_X_GENERIC);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".gif",
                                                EWL_ICON_IMAGE_X_GENERIC);

                /* Videos */
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".wmv",
                                                EWL_ICON_VIDEO_X_GENERIC);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".mpg",
                                                EWL_ICON_VIDEO_X_GENERIC);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".mpeg",
                                                EWL_ICON_VIDEO_X_GENERIC);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".avi",
                                                EWL_ICON_VIDEO_X_GENERIC);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".mov",
                                                EWL_ICON_VIDEO_X_GENERIC);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".asf",
                                                EWL_ICON_VIDEO_X_GENERIC);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".mp4",
                                                EWL_ICON_VIDEO_X_GENERIC);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".mkv",
                                                EWL_ICON_VIDEO_X_GENERIC);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".ogm",
                                                EWL_ICON_VIDEO_X_GENERIC);

                /* Audio */
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".mp3",
                                                EWL_ICON_AUDIO_X_GENERIC);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".mka",
                                                EWL_ICON_AUDIO_X_GENERIC);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".ogg",
                                                EWL_ICON_AUDIO_X_GENERIC);

                /* HTML */
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".html",
                                                EWL_ICON_TEXT_HTML);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".htm",
                                                EWL_ICON_TEXT_HTML);

                /* Scirpts */
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".pl",
                                                EWL_ICON_TEXT_X_SCRIPT);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".sh",
                                                EWL_ICON_TEXT_X_SCRIPT);
                cmaid_map_set(ewl_io_manager_ext_icon_map, ".ksh",
                                                EWL_ICON_TEXT_X_SCRIPT);
...
ewl_io_manager_shutdown(void)
{
        ...
        IF_FREE_CONTAINER(ewl_io_manager_ext_icon_map);
...
ewl_io_manager_extension_icon_name_get(const char *ext)
{
        ...
        ret = cmaid_map_get(ewl_io_manager_ext_icon_map, ext);
