...
reparent_cb(Ewl_Widget *w, void *ev __UNUSED__, void *data)
{
	Cmaid_Iter iter;
        ...
        ewl_container_child_iterator_attach(d2, &iter);
        o = cmaid_iter_next(&iter);
        ...
        ewl_widget_enable(o);
        ewl_container_child_iterator_detach(d2, &iter);
}
...
debug_callbacks_append(Ewl_Widget *w)
{
		...
		Cmaid_Iter iter;
                ...
                /* append the callbacks also for the children */
